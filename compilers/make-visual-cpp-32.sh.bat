...
@set PATH=z:\tmp\ide;%~dp0\..\cl_deps;%~dp0\visual-cpp-2013\vc-12.0\bin;%~dp0\visual-cpp-2013\vc-12.0\redist\x86\microsoft.vc120.crt;%~dp0\visual-cpp-2013\winsdk-v7.1a\bin;%PATH%
@set INCLUDE=%~dp0\visual-cpp-2013\vc-12.0\include;%~dp0\visual-cpp-2013\winsdk-v7.1a\include
@set LIB=%~dp0\visual-cpp-2013\vc-12.0\lib;%~dp0\visual-cpp-2013\winsdk-v7.1a\lib
